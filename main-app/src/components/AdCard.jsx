...
export default function AdCard({ ad, onFavToggle, compact = false }) {
  ...
  const imageHeight = compact ? 60 : 70;
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '6px 8px 6px' }}>
        ...
        <p style={{ fontSize: 11, fontWeight: 700, color: '#1a1a2e', lineHeight: 1.3, marginBottom: 2, display: '-webkit-box', WebkitLineClamp: 1, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
          {ad.title}
        </p>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 3 }}>
          <span style={{ fontSize: 14, fontWeight: 900, color: '#1a2b5f' }}>₹{Number(ad.price).toLocaleString('en-IN')}</span>
          {priceLabel && <span style={{ fontSize: 9, color: '#6b7280', fontWeight: 600 }}>{priceLabel}</span>}
        </div>
