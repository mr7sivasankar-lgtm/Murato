...
import {
  ...
  Settings, LogOut, Star, MapPin, Phone, MessageSquare, Edit3, LifeBuoy, X, Lock, Globe, Shield, FileText
} from 'lucide-react';
  ...
  return (
    <div className="page page-enter" style={{ paddingBottom: 90 }}>
      ...
      <div style={{ background: 'white', marginBottom: 12, boxShadow: '0 1px 6px rgba(0,0,0,0.05)' }}>
        ...
        <MenuItem icon={<FileText size={18} />} label="Terms & Conditions" sub="Read our terms" onClick={() => navigate('/terms')} color="#14b8a6" />
