  ...
  return (
    <div className="page page-enter" style={{ background: '#ffffff', minHeight: '100dvh' }}>
      <div className="page-header" style={{ display: 'flex', alignItems: 'center', gap: 12, position: 'sticky', top: 0, zIndex: 100, background: '#ffffff', borderBottom: '1px solid #e5e7eb', padding: '16px 20px' }}>
        ...
        <h1 style={{ fontSize: 18, fontWeight: 800, color: 'var(--navy)', margin: 0 }}>Terms & Conditions</h1>
      </div>
      <div 
        className="container" 
        style={{ 
